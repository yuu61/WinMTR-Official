...
// Fixed-size buffer for the auto-start hostname copied in from the command line.
constexpr size_t kDefaultHostNameBufferSize = 1000;
...
protected:
	...
	wchar_t msz_defaulthostname[kDefaultHostNameBufferSize]{};
